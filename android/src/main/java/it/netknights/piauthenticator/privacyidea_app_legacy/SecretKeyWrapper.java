...
import static it.netknights.piauthenticator.privacyidea_app_legacy.AppConstants.KEY_WRAP_ALGORITHM;
import static it.netknights.piauthenticator.privacyidea_app_legacy.Util.logprint;
...
//        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            ...
            System.out.println("XX SecretKeyWrapper: " + privateKey.getEncoded());
